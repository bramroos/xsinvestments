...
class Redux_Options_sorter extends Redux_Options {
    ...
    function render() {
        ...
        ?>
        <script>
            var_opt_name = '<?php echo esc_attr($this->args['opt_name']); ?>';
        </script>
        <?php
        echo '<div id="' . $this->field['id'] . '" class="' . $class . '">';
        if ($value) {
            foreach ($options as $group => $sortlist) {
                ...
                foreach ($sortlist as $key => $list) {
                    ...
                    if ($key != "placebo") {
                        ...
                        echo '<input class="position" type="hidden" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][' . $group . '][' . $key . ']" value="' . $list . '">';
