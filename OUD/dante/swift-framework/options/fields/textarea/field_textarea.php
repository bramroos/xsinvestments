...
class Redux_Options_textarea {
    ...
    */
    function render() {
        ...
        <textarea name="<?php echo esc_attr($name); ?>" id="<?php echo esc_attr($id); ?>" <?php echo (isset($this->field['placeholder'])) ? ' placeholder="' . esc_attr($this->field['placeholder']) . '" ' : ''; ?> class="<?php echo esc_attr($class); ?>" rows="<?php echo esc_attr($rows); ?>"><?php echo esc_attr($this->value); ?></textarea>
