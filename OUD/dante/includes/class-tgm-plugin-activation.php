...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function install_plugins_page() {
			...
			$this->latest_plugin_versions = $this->dante_check_latest_plugin_versions();
		...
		public function dante_check_latest_plugin_versions() {
			
			// Do we have this information in our transients already?
			$transient = get_transient( 'dante_remote_plugin_update_check' );
			...
			// Nope!  We gotta make a call.
				...
				$dante_latest_plugins_versions = array();
				...
				foreach ($arr as $plugin){
					...
					if( isset( $plugin_fields[0]) &&  $plugin_fields[0] != '' ){
						...
						$dante_latest_plugins_versions[$plugin_slug] = array( 'name' => $plugin_name, 'slug' => $plugin_slug, 'version'  => $plugin_version ); 
				...
				set_transient( 'dante_remote_plugin_update_check', $dante_latest_plugins_versions, $cache_time );
				
				// Return plugin versions
				return $dante_latest_plugins_versions;
		...
		public function does_plugin_require_update( $slug ) {
			...
			$latest_plugins = $this->dante_check_latest_plugin_versions();
