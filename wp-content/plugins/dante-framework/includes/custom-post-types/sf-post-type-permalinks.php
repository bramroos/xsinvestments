    ...
    if ( ! class_exists( 'sf_post_type_permalinks' ) ) :
        ...
        class sf_post_type_permalinks {
            ...
            public function settings_init() {
                ...
                add_settings_section( 'sf-portfolio-permalink', __( 'Portfolio permalink base', 'dante-framework' ), array(
                        $this,
                        'portfolio_settings'
                    ), 'permalink' );

                // Add portfolio settings
                add_settings_field( 'portfolio_category_slug', __( 'Portfolio category base', 'dante-framework' ), array(
                        $this,
                        'portfolio_category_slug_input'
                    ), 'permalink', 'optional' );

                // Add galleries section to the permalinks page
                add_settings_section( 'sf-galleries-permalink', __( 'Galleries permalink base', 'dante-framework' ), array(
                        $this,
                        'galleries_settings'
                    ), 'permalink' );

                // Add galleries settings
                add_settings_field( 'galleries_category_slug', __( 'Galleries category base', 'dante-framework' ), array(
                        $this,
                        'galleries_category_slug_input'
                    ), 'permalink', 'optional' );

                // Add team section to the permalinks page
                add_settings_section( 'sf-team-permalink', __( 'Team permalink base', 'dante-framework' ), array(
                        $this,
                        'team_settings'
                    ), 'permalink' );

                // Add team settings
                add_settings_field( 'team_category_slug', __( 'Team category base', 'dante-framework' ), array(
                        $this,
                        'team_category_slug_input'
                    ), 'permalink', 'optional' );

                // Add team section to the permalinks page
                add_settings_section( 'sf-directory-permalink', __( 'Directory permalink base', 'dante-framework' ), array(
                        $this,
                        'directory_settings'
                    ), 'permalink' );

                // Add team settings
                add_settings_field( 'directory_category_slug', __( 'Directory category base', 'dante-framework' ), array(
                        $this,
                        'directory_category_slug_input'
                    ), 'permalink', 'optional' );

                // Add team settings
                add_settings_field( 'directory_location_slug', __( 'Directory location base', 'dante-framework' ), array(
                        $this,
                        'directory_location_slug_input'
                    ), 'permalink', 'optional' );

                // Add faqs section to the permalinks page
                add_settings_section( 'sf-faqs-permalink', __( 'FAQs permalink base', 'dante-framework' ), array(
                        $this,
                        'faqs_settings'
                    ), 'permalink' );

                // Add team settings
                add_settings_field( 'faqs_category_slug', __( 'FAQ category base', 'dante-framework' ), array(
                        $this,
            ...
            public function portfolio_category_slug_input() {
                ...
                <input name="portfolio_category_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'portfolio-category', 'dante-framework' ) ?>"/>
            <?php
            }
            ...
            public function galleries_category_slug_input() {
                ...
                <input name="galleries_category_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'galleries-category', 'dante-framework' ) ?>"/>
            <?php
            }
            ...
            public function team_category_slug_input() {
                ...
                <input name="team_category_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'team-category', 'dante-framework' ) ?>"/>
            <?php
            }
            ...
            public function directory_category_slug_input() {
                ...
                <input name="directory_category_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'directory-category', 'dante-framework' ) ?>"/>
            <?php
            }
            ...
            public function directory_location_slug_input() {
                ...
                <input name="directory_location_slug" type="text" class="regular-text code"
                       ...
                       } ?>" placeholder="<?php echo __( 'directory-location', 'dante-framework' ) ?>"/>
            <?php
            }
            ...
            public function portfolio_settings() {
                echo wpautop( __( 'These settings control the permalinks used for portfolio items. These settings only apply when <strong>not using "default" permalinks above</strong>.', 'dante-framework' ) );
                ...
                // Get portfolio page
                global $sf_options;
                $portfolio_page = __( $sf_options['portfolio_page'], 'dante-framework' );
                $base_slug      = ( $portfolio_page > 0 && get_page( $portfolio_page ) ) ? get_page_uri( $portfolio_page ) : __( 'portfolio', 'dante-framework' );
                $portfolio_base = __( 'portfolio', 'dante-framework' );
                ...
                <table class="form-table">
                    <tbody>
                    <tr>
                        <th><label><input name="portfolio_permalink" type="radio" value="<?php echo esc_attr($structures[0]); ?>"
                                          class="sf_port_tog" <?php checked( $structures[0], $portfolio_permalink ); ?> /> <?php _e( 'Default', 'dante-framework' ); ?>
                            </label></th>
                        <td><code><?php echo home_url(); ?>/?portfolio=sample-portfolio-item</code></td>
                    </tr>
                    <tr>
                        <th><label><input name="portfolio_permalink" type="radio" value="<?php echo esc_attr($structures[1]); ?>"
                                          class="sf_port_tog" <?php checked( $structures[1], $portfolio_permalink ); ?> /> <?php _e( 'Portfolio', 'dante-framework' ); ?>
                            </label></th>
                        <td><code><?php echo home_url(); ?>/<?php echo esc_url($portfolio_base); ?>/sample-portfolio-item/</code>
                        </td>
                    </tr>
                    <?php if ( $portfolio_page ) : ?>
                        <tr>
                            <th><label><input name="portfolio_permalink" type="radio"
                                              ...
                                              class="sf_port_tog" <?php checked( $structures[2], $portfolio_permalink ); ?> /> <?php _e( 'Portfolio base', 'dante-framework' ); ?>
                                </label></th>
                            <td><code><?php echo home_url(); ?>/<?php echo esc_url($base_slug); ?>/sample-portfolio-item/</code>
                            </td>
                        </tr>
                        <!--<tr>
							<th><label><input name="portfolio_permalink" type="radio" value="<?php echo esc_attr($structures[3]); ?>" class="sftog" <?php checked( $structures[3], $portfolio_permalink ); ?> /> <?php _e( 'Portfolio base with category', 'dante-framework' ); ?></label></th>
							<td><code><?php echo home_url(); ?>/<?php echo esc_url($base_slug); ?>/portfolio-category/sample-portfolio-item/</code></td>
						</tr>-->
                    <?php endif; ?>
                    <tr>
            ...
            public function galleries_settings() {
                echo wpautop( __( 'These settings control the permalinks used for galleries. These settings only apply when <strong>not using "default" permalinks above</strong>.', 'dante-framework' ) );
                ...
                $base_slug      = __( 'galleries', 'dante-framework' );
                $galleries_base = __( 'galleries', 'dante-framework' );
                ...
                <table class="form-table">
                    <tbody>
                    <tr>
                        <th><label><input name="galleries_permalink" type="radio" value="<?php echo esc_attr($structures[0]); ?>"
                                          class="sf_gal_tog" <?php checked( $structures[0], $galleries_permalink ); ?> /> <?php _e( 'Default', 'dante-framework' ); ?>
                            </label></th>
                        <td><code><?php echo home_url(); ?>/?galleries=sample-gallery</code></td>
                    </tr>
                    <tr>
                        <th><label><input name="galleries_permalink" type="radio" value="<?php echo esc_attr($structures[1]); ?>"
                                          class="sf_gal_tog" <?php checked( $structures[1], $galleries_permalink ); ?> /> <?php _e( 'Galleries', 'dante-framework' ); ?>
                            </label></th>
                        <td><code><?php echo home_url(); ?>/<?php echo esc_url($galleries_base); ?>/sample-gallery/</code></td>
                    </tr>
                    <tr>
            ...
            public function team_settings() {
                echo wpautop( __( 'These settings control the permalinks used for team members. These settings only apply when <strong>not using "default" permalinks above</strong>.', 'dante-framework' ) );
                ...
                $base_slug = __( 'team', 'dante-framework' );
                $team_base = __( 'team', 'dante-framework' );
                ...
                <table class="form-table">
                    <tbody>
                    <tr>
                        <th><label><input name="team_permalink" type="radio" value="<?php echo esc_attr($structures[0]); ?>"
                                          class="sf_team_tog" <?php checked( $structures[0], $team_permalink ); ?> /> <?php _e( 'Default', 'dante-framework' ); ?>
                            </label></th>
                        <td><code><?php echo home_url(); ?>/?team=sample-team-member</code></td>
                    </tr>
                    <tr>
                        <th><label><input name="team_permalink" type="radio" value="<?php echo esc_attr($structures[1]); ?>"
                                          class="sf_team_tog" <?php checked( $structures[1], $team_permalink ); ?> /> <?php _e( 'Team', 'dante-framework' ); ?>
                            </label></th>
                        <td><code><?php echo home_url(); ?>/<?php echo esc_url($team_base); ?>/sample-team-member/</code></td>
                    </tr>
                    <tr>
            ...
            public function directory_settings() {
                echo wpautop( __( 'These settings control the permalinks used for directory items. These settings only apply when <strong>not using "default" permalinks above</strong>.', 'dante-framework' ) );
                ...
                $base_slug      = __( 'directory', 'dante-framework' );
                $directory_base = __( 'directory', 'dante-framework' );
                ...
                <table class="form-table">
                    <tbody>
                    <tr>
                        <th><label><input name="directory_permalink" type="radio" value="<?php echo esc_attr($structures[0]); ?>"
                                          class="sf_directory_tog" <?php checked( $structures[0], $directory_permalink ); ?> /> <?php _e( 'Default', 'dante-framework' ); ?>
                            </label></th>
                        <td><code><?php echo home_url(); ?>/?directory=sample-listing</code></td>
                    </tr>
                    <tr>
                        <th><label><input name="directory_permalink" type="radio" value="<?php echo esc_attr($structures[1]); ?>"
                                          class="sf_directory_tog" <?php checked( $structures[1], $directory_permalink ); ?> /> <?php _e( 'Directory', 'dante-framework' ); ?>
                            </label></th>
                        <td><code><?php echo home_url(); ?>/<?php echo esc_url($directory_base); ?>/sample-listing/</code></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input name="directory_permalink_structure" id="sf_directory_permalink_structure"
                                   ...
                                   class="regular-text code"> <span
                                class="description"><?php _e( 'Enter a custom base to use. A base <strong>must</strong> be set or WordPress will use default instead.', 'dante-framework' ); ?></span>
                        </td>
                    </tr>
                    </tbody>
                </table>
            ...
            public function faqs_settings() {
                echo wpautop( __( 'These settings control the permalinks used for FAQs. These settings only apply when <strong>not using "default" permalinks above</strong>.', 'dante-framework' ) );
                ...
                // Set base slug & directory base
                $base_slug      = __( 'faqs', 'dante-framework' );
                $faqs_base = __( 'faqs', 'dante-framework' );
                ...
                <table class="form-table">
                    <tbody>
                    <tr>
                        <th><label><input name="faqs_permalink" type="radio" value="<?php echo esc_attr($structures[0]); ?>"
                                          class="sf_faqs_tog" <?php checked( $structures[0], $faqs_permalink ); ?> /> <?php _e( 'Default', 'dante-framework' ); ?>
                            </label></th>
                        <td><code><?php echo home_url(); ?>/?faqs=sample-faq-item</code></td>
                    </tr>
                    <tr>
                        <th><label><input name="faqs_permalink" type="radio" value="<?php echo esc_attr($structures[1]); ?>"
                                          class="sf_faqs_tog" <?php checked( $structures[1], $faqs_permalink ); ?> /> <?php _e( 'FAQs', 'dante-framework' ); ?>
                            </label></th>
                        <td><code><?php echo home_url(); ?>/<?php echo esc_url($faqs_base); ?>/sample-faq-item/</code>
                        </td>
                    </tr>
                    <tr>
