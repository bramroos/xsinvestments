...
class Twitter_Widget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		$result .= dante_latest_tweet($tweets, $username);
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('username'); ?>"><?php esc_html_e( 'Your Twitter Username', 'dante-framework' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id('posts'); ?>"><?php esc_html_e( 'Display how many tweets?', 'dante-framework' ); ?></label>
