	...
	*/
	...
	class sf_recent_portfolio extends WP_Widget {
		...
		function form( $instance ) {	
				...
				<p>
					<label for="<?php echo $this->get_field_id('number'); ?>"><?php esc_html_e( 'Number of items to show:', 'dante-framework' ); ?></label>
				...
				<p>
					...
					<?php
					$options = dante_framework_get_category_list('portfolio-category');
