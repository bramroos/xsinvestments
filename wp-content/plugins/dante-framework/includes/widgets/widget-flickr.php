    ...
    */
    ...
    class sf_flickr_widget extends WP_Widget {
        ...
        function form( $instance ) {
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_html_e( 'Title', 'dante-framework' ); ?>
                    :</label>
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id( 'flickr_id' )); ?>"><?php esc_html_e( 'Flickr ID', 'dante-framework' ); ?>
                    :</label>
                <input class="widefat" id="<?php echo esc_attr($this->get_field_id( 'flickr_id' )); ?>"
                       name="<?php echo esc_attr($this->get_field_name( 'flickr_id' )); ?>" type="text"
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"><?php esc_html_e( 'Number of Photos', 'dante-framework' ); ?>
                    :</label>
            ...
            <script type="text/javascript">
                jQuery( document ).ready(
                    function( $ ) {
                        ...
                        $.getJSON(
                            "//api.flickr.com/services/feeds/photos_public.gne?ids=<?php echo esc_url($flickrid); ?>&lang=en-us&format=json&jsoncallback=?",
                            function( data ) {
                                $.each(
