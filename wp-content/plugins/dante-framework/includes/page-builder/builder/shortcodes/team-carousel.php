...
class SwiftPageBuilderShortcode_team_carousel extends SwiftPageBuilderShortcode {
    ...
    protected function content($atts, $content = null) {
    		...
    		$sidebar_config = dante_framework_get_post_meta(get_the_ID(), 'sf_sidebar_config', true);
    		...
    		if( have_posts() ) {
    			...
    			while ( have_posts() ) {
    				...
    				$member_bio = dante_excerpt($excerpt_length);
    				$custom_excerpt = dante_framework_get_post_meta($post->ID, 'sf_custom_excerpt', true);
    				if ($custom_excerpt != "") {
    					$member_bio = dante_custom_excerpt($custom_excerpt, $excerpt_length);
    				}
					...
					$image = dante_aq_resize( $img_url, $thumb_size, $thumb_size, true, false);
