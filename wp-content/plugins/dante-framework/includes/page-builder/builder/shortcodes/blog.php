	...
	class SwiftPageBuilderShortcode_blog extends SwiftPageBuilderShortcode {
	    ...
	    protected function content($atts, $content = null) {
	        ...
	        if ($show_blog_aux == "yes" && $sidebars == "no-sidebars") {
	        	$blog_aux = dante_blog_aux($width);
	        }
	        
	        
	        /* BLOG ITEMS
	        ================================================== */ 
	        $items = dante_blog_items($blog_type, $masonry_effect_type, $show_title, $show_excerpt, $show_details, $excerpt_length, $content_output, $show_read_more, $item_count, $category, $exclude_categories, $pagination, $sidebars, $width, $offset, $posts_order);
            ...
            global $dante_has_blog, $dante_include_imagesLoaded;
