...
class SwiftPageBuilderShortcode_portfolio_showcase extends SwiftPageBuilderShortcode {
    ...
    protected function content($atts, $content = null) {
			...
			while ( $portfolio_items->have_posts() ) : $portfolio_items->the_post();
				...
				$item_subtitle = dante_framework_get_post_meta($post->ID, 'sf_portfolio_subtitle', true);
				...
				$image = dante_aq_resize( $thumb_img_url, $image_width, $image_height, true, false);
            ...
            global $dante_has_portfolio_showcase;
            $dante_has_portfolio_showcase = true;
