    ...
    */
    ...
    class SwiftPageBuilderShortcode_spb_parallax extends SwiftPageBuilderShortcode {
        ...
        protected function content( $atts, $content = null ) {
            ...
            $sidebars = '';
            if ( ( $dante_sidebar_config == "left-sidebar" ) || ( $dante_sidebar_config == "right-sidebar" ) ) {
            ...
            if ( $parallax_type == "video" ) {
                ...
                if ( $img_url[0] != "" ) {
                    if ( $parallax_image_movement == "stellar" ) {
                        $output .= "\n\t" . '<div class="spb_parallax_asset sf-parallax parallax-' . $parallax_image_height . ' parallax-' . $parallax_image_movement . ' spb_content_element bg-type-' . $bg_type . ' ' . $width . $el_class . ' '.$alt_background.'" style="background-image: url(' . $img_url[0] . ');" data-stellar-background-ratio="' . $parallax_image_speed . '" data-v-center="true">';
                    } else {
                        $output .= "\n\t" . '<div class="spb_parallax_asset sf-parallax parallax-' . $parallax_image_height . ' parallax-' . $parallax_image_movement . ' spb_content_element bg-type-' . $bg_type . ' ' . $width . $el_class . ' '.$alt_background.'" style="background-image: url(' . $img_url[0] . ');" data-v-center="true">';
                    }
                } else {
                    $output .= "\n\t" . '<div class="spb_parallax_asset sf-parallax parallax-' . $parallax_image_height . ' spb_content_element bg-type-' . $bg_type . ' ' . $width . $el_class . ' '.$alt_background.'" data-v-center="true">';
                }
            }
            ...
            global $dante_include_parallax;
            $dante_include_parallax = true;
