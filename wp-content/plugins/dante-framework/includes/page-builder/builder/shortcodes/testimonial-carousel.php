...
class SwiftPageBuilderShortcode_testimonial_carousel extends SwiftPageBuilderShortcode {
    ...
    public function content( $atts, $content = null ) {
        ...
        while ( $testimonials->have_posts() ) : $testimonials->the_post();
        	...
        	$testimonial_cite = dante_framework_get_post_meta($post->ID, 'sf_testimonial_cite', true);
        	$testimonial_cite_subtext = dante_framework_get_post_meta($post->ID, 'sf_testimonial_cite_subtext', true);
        	...
        	$testimonial_image = dante_aq_resize( $testimonial_image_url, 70, 70, true, false);
        ...
        $items .= '<a href="#" class="carousel-prev"><i class="fas fa-chevron-left"></i></a><a href="#" class="carousel-next"><i class="fas fa-chevron-right"></i></a>';
...
SPBMap::map( 'testimonial_carousel', array(
    ...
    "params"	=> array(
        ...
        array(
            ...
            "param_name" => "category",
            "value" => dante_framework_get_category_list('testimonials-category'),
