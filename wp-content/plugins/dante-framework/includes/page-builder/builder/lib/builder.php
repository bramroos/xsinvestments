	...
	*/
	...
	class SwiftPageBuilder extends SFPageBuilderAbstract {
	    ...
	    public function getPostTypes() {
	        ...
	        $post_types = apply_filters('spb_post_types', $this->postTypes);
	    ...
	    public function elementBackendHtmlJavascript_callback() {
	        ...
	        if ( $data_element == 'spb_column' && $this->post( 'data_width' )!==null ) {
	            ...
	            echo $output;
				         ...
				         $output = do_shortcode( '[spb_text_block]'.__("<p>This is a text block. Click the edit button to change this text.</p>", 'dante-framework').'[/spb_text_block]' );
	            	echo $output;
	        }
			 else {
	    ...
	    public function deleteTemplateJavascript_callback() {
            ...
            if ( $element_name == 'Tabs' ) {
                $singular_name = __( "Tab", 'dante-framework' );
            } else {
                $singular_name = __( "Section", 'dante-framework' );
            }
