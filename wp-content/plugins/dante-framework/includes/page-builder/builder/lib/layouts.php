	...
	*/
	...
	class SPBLayoutButton implements SPBTemplateInterface {
        ...
        public function output( $post = null ) {
            ...
            if ( $this->params['id'] == "row" ) {
                $output = '<li class="row-option"><a id="' . $this->params['id'] . '" data-element="spb_row" data-width="' . $this->params['id'] . '" class="' . $this->params['id'] . ' clickable_layout_action dropable_column" href="#"><span>' . __( $this->params['title'], 'dante-framework' ) . '</span></a></li>';
            } else {
                $output = '<li><a id="' . $this->params['id'] . '" data-element="spb_column" data-width="' . $this->params['id'] . '" class="' . $this->params['id'] . ' clickable_layout_action dropable_column" href="#"><span>' . __( $this->params['title'], 'dante-framework' ) . '</span></a></li>';
            }
	...
	class SPBTemplateMenuButton implements SPBTemplateInterface {
	    ...
	    public function output($post = null) {
	        ...
	        $output = '<li class="spb_template_li"><a data-template_id="'.$this->id.'" href="#">'.__($this->params['name'], 'dante-framework').'</a> <span class="spb_remove_template"><i class="icon-trash spb_template_delete_icon"> </i> </span></li>';
	        return $output;
	    }
	}
	...
	class SPBElementButton implements SPBTemplateInterface {
	    ...
	    public function output($post = null) {
	        ...
	        $output .= '<li class="' . $this->base . '"><a data-element="' . $this->base . '" id="' . $this->base . '" class="dropable_el clickable_action'.$class.'" href="#">' . $this->getIcon() . __($this->params["name"], 'dante-framework') .'</a></li>';
	...
	class SPBTemplateMenu implements SPBTemplateInterface {
	    ...
	    public function output( $post = null ) {
	        if(empty($this->params)) return '';
	        $output =  '<li class="nav-header">'.__('Save Template', 'dante-framework').'</li>
		                <li id="spb_save_template"><a href="#">'.__('Save current page as a Template', 'dante-framework').'</a></li>
		                <li class="divider"></li>
		                <li class="nav-header">'.__('Load Template', 'dante-framework').'</li>';
	        $is_empty = true;
	        ...
	        if($is_empty) $output .= '<li class="spb_no_templates"><span>'.__('No custom templates yet.', 'dante-framework').'</span></li>';
	        return $output;
	    }
	}
	...
	class SPBNavBar implements SPBTemplateInterface {
	    ...
	    public function output($post = null) {
	                        ...
	                        <div class="nav-collapse">
	                            <ul class="nav">
	                                <li class="dropdown content-dropdown">
	                                    <a class="dropdown-toggle spb_content_elements" data-slideout="spb-content-elements" href="#">'.__("Choose Elements", 'dante-framework').' <b class="caret"></b></a>
            ...
            $output .= '<ul class="nav pull-left columns-dropdown">
            	                            	<li class="dropdown">
                    								<a class="dropdown-toggle spb_columns" href="#">' . __( "Layout", 'dante-framework' ) . ' <b class="caret"></b></a>
			...
			$output .= '<ul class="nav pull-left pre-built-pages-nav">
	                                <li class="dropdown">
	                                    <a class="dropdown-toggle spb_prebuilt_pages" data-slideout="spb-prebuilt-pages" href="#">'.__('Pre-Built Pages', 'dante-framework').' <b class="caret"></b></a>
	                            ...
	                            <ul class="nav pull-left custom-templates-nav">
	                                <li class="dropdown">
	                                    <a class="dropdown-toggle spb_templates" data-slideout="spb-custom-templates" href="#">'.__('Custom Templates', 'dante-framework').' <b class="caret"></b></a>
	                                    <ul class="dropdown-menu spb_templates_ul">
	                            ...
	                            <ul class="nav pull-left">
	                            	<li>
	                            		<a id="clear-spb" href="#">' . __( 'Clear All Content', 'dante-framework' ) . '</a>
	                            	</li>
	                            </ul>
	...
	class SPBLayout implements  SPBTemplateInterface {
		...
		public function getContainerHelper() {
			...
			$cont_help .= '<a href="javascript:open_elements_dropdown();" class="open-dropdown-content-element"><i class="icon"></i> ' . __( 'Add Content Elements', 'dante-framework' ) . '</a>
			<span>' . __("- or -", 'dante-framework') .'</span>
			<a href="#" class="add-text-block-to-content" parent-container="#spb_content"><i class="icon"></i> ' . __( 'Add a Text Block', 'dante-framework' ) . '</a>';
			$cont_help .= '</div>';
	    ...
	    public function output($post = null) {
	        ...
	        $output .= '<div class="metabox-builder-content">
						...
						<div id="spb_content" class="spb_main_sortable main_wrapper row-fluid spb_sortable_container">
							'.__("Loading, please wait...", 'dante-framework').'
						</div>
						<div id="spb-empty">
							<h2>' . __("Welcome to your visual preview area...<br> You don’t have any content at the moment.", 'dante-framework') .'</h2>
							<div class="unhappy-face"></div>
							<ul class="helper-steps">
								<li>
									<strong>' . __("Step 1:", 'dante-framework') .'</strong>
								...
								<li>
									<strong>' . __("Step 2:", 'dante-framework') .'</strong>
	        ...
	        $output .= '<input type="hidden" id="spb_loading" name="spb_loading" value="'. __("Loading, please wait...", 'dante-framework') .'" />';
