...
jQuery(function(jQuery) {
	...
	var $sidebar_config = jQuery('#dante_sidebar_config'), 
		$left_sidebar = jQuery('#dante_left_sidebar').parent().parent(),
		$right_sidebar = jQuery('#dante_right_sidebar').parent().parent();
	var $show_swift_slider = jQuery('#dante_posts_slider'),
		$posts_slider_type = jQuery('#dante_posts_slider_type'), 
		$slider_posts_category = jQuery('#dante_posts_slider_category').parent().parent(),
		$slider_portfolio_category = jQuery('#dante_posts_slider_portfolio_category').parent().parent(),
		$slider_count = jQuery('#dante_posts_slider_count').parent().parent(),
		$revslider_alias = jQuery('#dante_rev_slider_alias').parent().parent(),
		$layerslider_id = jQuery('#dante_layerslider_id').parent().parent();
	var $thumb_type = jQuery('#dante_thumbnail_type'),
		$thumb_image = jQuery('#dante_thumbnail_image_description').parent().parent(),
		$thumb_video = jQuery('#dante_thumbnail_video_url').parent().parent(),
		$thumb_gallery = jQuery('#dante_thumbnail_gallery_description').parent().parent();
	var $link_type = jQuery('#dante_thumbnail_link_type'),
		$link_url = jQuery('#dante_thumbnail_link_url').parent().parent(),
		$link_image = jQuery('a[data-field_id="dante_thumbnail_link_image"]').parent().parent(),
		$link_video = jQuery('#dante_thumbnail_link_video_url').parent().parent();
	var $use_thumb_content = jQuery('#dante_thumbnail_content_main_detail'),
		$detail_type = jQuery('#dante_detail_type'),
		$detail_image = jQuery('#dante_detail_image_description').parent().parent(),
		$detail_video = jQuery('#dante_detail_video_url').parent().parent(),
		$detail_gallery = jQuery('#dante_detail_gallery_description').parent().parent(),
		$detail_slider = jQuery('#dante_detail_rev_slider_alias').parent().parent(),
		$detail_layerslider = jQuery('#dante_detail_layer_slider_alias').parent().parent(),
		$detail_custom = jQuery('#dante_custom_media').parent().parent();
	var $page_title_style = jQuery('#dante_page_title_style'), 
		$page_title_text_two = jQuery('#dante_page_title_two').parent().parent(),
		$page_title_fancy_image = jQuery('#dante_page_title_image_description').parent().parent(),
		$page_title_fancy_text_style = jQuery('#dante_page_title_text_style').parent().parent();
	...
	var altBackgroundValue = jQuery('.rwmb-meta-box').find('#dante_page_title_bg').val();
	...
	function dante_setup_metatabs() {
	
		var sfMetaBox = jQuery('#dante_meta_box');
