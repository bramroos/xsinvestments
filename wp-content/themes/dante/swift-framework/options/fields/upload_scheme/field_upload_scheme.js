...
//                  console.log (attachment);
                    ...
                    if ( attachment.attributes.url ) {
					    ...
					    jQuery.ajax({
					           ...
					           type:'POST',
					           dataType: "html",
					           data:'action=dante_add_schema_ajax&file_id=' + attachment.attributes.id + '&file_url=' + attachment.attributes.url + '&xxx=',
    ...
    jQuery("a.save-this-scheme").click( function( event ) {
        ...
        if ( scheme_name ) {
		    ...
		    jQuery.ajax({
		           ...
		           type:'POST',
		           dataType: "html",
		           data:'action=dante_save_schema_ajax&schema_name=' + scheme_name + '&xxx=',
		           success:function(results) {
    ...
    jQuery("a.use-this-scheme").click( function( event ) {
        ...
        if ( selected ) {
		    ...
		    jQuery.ajax({
		           ...
		           type:'POST',
		           dataType: "html",
		           data:'action=dante_use_schema_ajax&schema_id=' + selected + '&xxx=',
		           success:function(results) {
    ...
    jQuery("a.delete-this-scheme").click( function( event ) {
        ...
        if ( selected ) {
		    ...
		    jQuery.ajax({
		           ...
		           type:'POST',
		           dataType: "html",
		           data:'action=dante_delete_schema_ajax&schema_id=' + selected + '&xxx=',
		           success:function(results) {
	...
	function updateSchemaHTML ( selected ) {
	    ...
	    jQuery.ajax({
	           ...
	           type:'POST',
	           dataType: "html",
	           data:'action=dante_get_schema_html_ajax&schema_id=' + selected + '&xxx=',
	           success:function(results) {
