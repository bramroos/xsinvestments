<?php
class Redux_Options_upload_scheme {
...
//      echo '<img class="redux-opts-screenshot" id="redux-opts-screenshot-' . $this->field['id'] . '" src="' . $this->value . '" />';
        ...
        echo ' <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="redux-opts-upload-scheme button-secondary"' . $upload . ' rel-id="' . $this->field['id'] . '">' . __('Import', 'dante') . '</a>';
        echo ' <span class="import-schema-message" style="display:none;">Import Successful</span> ';
//      echo ' <a href="javascript:void(0);" class="redux-opts-upload-scheme-remove"' . $remove . ' rel-id="' . $this->field['id'] . '">' . __('Remove Upload', 'dante') . '</a>';
    ...
    */
    ...
    // gobal $wp_version; //AP: why doesn't this work?!?!
        ...
        if ( $wp_version < "3.5" ) {
            wp_enqueue_script(
                'redux-opts-field-upload-scheme-js', 
                Redux_OPTIONS_URL . 'fields/upload_scheme/field_upload_scheme_3_4.js', 
            ...
            wp_enqueue_script(
                'redux-opts-field-upload-scheme-js', 
                Redux_OPTIONS_URL . 'fields/upload_scheme/field_upload_scheme.js', 
                array('jquery'),
                time(),
                true
            );
