...
class Redux_Options_google_webfonts {
    ...
    */
    function render() {
        ...
        //echo '<p class="description" style="color:red;">' . __('The fonts provided below are free to use custom fonts from the <a href="'.$google_webfonts_url.'" target="_blank">Google Web Fonts directory</a>', 'dante') . '</p>';
