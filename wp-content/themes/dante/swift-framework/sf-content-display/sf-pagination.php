	...
	*/
	...
	if (!function_exists('pagenavi')) { 
		function pagenavi($query, $before = '', $after = '') {
		    ...
		    $pagenavi_options['first_text'] = __('First Page', 'dante');
		    $pagenavi_options['last_text'] = __('Last Page', 'dante');
		    $pagenavi_options['next_text'] = __("Next <i class='ss-navigateright'></i>", 'dante');
		    $pagenavi_options['prev_text'] = __("<i class='ss-navigateleft'></i> Previous", 'dante');
