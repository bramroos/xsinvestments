<?php
	...
	*/
 	...
 	/* CUSTOM CSS OUTPUT
 	================================================== */
 	if (!function_exists('dante_custom_styles')) {
		function dante_custom_styles() {
			...
			$hover_overlay_rgb = dante_hex2rgb($accent_color);
			}
			...
			$icon_container_border_color = dante_hex2rgb($icon_container_bg_color);
			$icon_color = get_option('dante_icon_color', '#1dc6df');
			$icon_alt_color = get_option('dante_icon_alt_color', '#ffffff');
			...
			global $post;
			if ($post) {
			$background_image_size = dante_get_post_meta($post->ID, 'sf_background_image_size', true);
			}
			...
			echo '.sf-icon-accent.sf-icon-cont, .sf-icon-accent > i, i.sf-icon-accent {color: '.$accent_color.';}';
			...
			echo '.sf-icon-secondary-accent.sf-icon-cont, .sf-icon-secondary-accent > i, i.sf-icon-secondary-accent {color: '.$secondary_accent_color.';}';
			...
			echo '.woocommerce table.shop_table tr td.product-remove .remove:hover, .woocommerce .coupon input.apply-coupon:hover, .woocommerce .shipping-calculator-form .update-totals-button button:hover, .woocommerce .quantity .plus:hover, .woocommerce .quantity .minus:hover, .add_review a:hover, .woocommerce #review_form #respond .form-submit input:hover, .lost_reset_password p.form-row input[type="submit"]:hover, .track_order p.form-row input[type="submit"]:hover, .change_password_form p input[type="submit"]:hover, .woocommerce table.my_account_orders .order-actions .button:hover, .woocommerce .widget_price_filter .price_slider_amount .button:hover, .woocommerce.widget .buttons a:hover, .woocommerce .wishlist_table tr td.product-add-to-cart a:hover, .woocommerce input.button[name="save_address"]:hover, .woocommerce input[name="apply_coupon"]:hover, .woocommerce button[name="apply_coupon"]:hover, .woocommerce .cart input[name="update_cart"]:hover, .woocommerce form.register input[type="submit"]:hover, .woocommerce form.cart button.single_add_to_cart_button:hover, .woocommerce form.cart .yith-wcwl-add-to-wishlist a:hover, .load-more-btn:hover, .woocommerce-account input[name="change_password"]:hover {background: '.$accent_color.'; color: '.$accent_alt_color.';}';
			...
			echo '.woocommerce input[name="apply_coupon"], .woocommerce button[name="apply_coupon"], .woocommerce .cart input[name="update_cart"], .woocommerce .shipping-calc-wrap button[name="calc_shipping"], .woocommerce-account input[name="change_password"] {background: '.$alt_bg_color.'!important; color: '.$secondary_accent_color.'!important}';
			echo '.woocommerce input[name="apply_coupon"]:hover, .woocommerce button[name="apply_coupon"]:hover, .woocommerce .cart input[name="update_cart"]:hover, .woocommerce .shipping-calc-wrap button[name="calc_shipping"]:hover, .woocommerce-account input[name="change_password"]:hover, .woocommerce input[name="save_account_details"]:hover {background: '.$accent_color.'!important; color: '.$accent_alt_color.'!important;}';
			...
			// USER STYLES
			if (get_option('sf_dante_options')['custom_css']) {
				echo "\n".'/*========== User Custom CSS Styles ==========*/'."\n";
				echo get_option('sf_dante_options')['custom_css'];
			}
		...
		add_action('wp_head', 'dante_custom_styles');
	}

	/* CUSTOM JS OUTPUT
	================================================== */
	function dante_custom_script() {
		if (get_option('sf_dante_options')['custom_js']) {
			echo get_option('sf_dante_options')['custom_js'];
		}
	}

	add_action('wp_footer', 'dante_custom_script');
?>